...
- [x] Configure RabbitMQ (Exchange, Queues, Routing Keys).
- [x] Configure WebSocket (STOMP Endpoint, Message Broker).
- [x] Implement WebSocket Security (JWT check on connection).
